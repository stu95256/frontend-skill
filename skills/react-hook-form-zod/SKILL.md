...
metadata:
  keywords: "react-hook-form, useForm, zod, zodResolver, form schema, useFieldArray, Controller, validation"
...
**Version policy**: Inspect the project's installed `react-hook-form`, `zod`, and `@hookform/resolvers` versions before choosing APIs. Use the lockfile and official documentation; do not copy fixed version numbers from this skill.

Before editing a form, use the project's package manager to inspect installed versions. Preserve the project's Zod major-version conventions and resolver import style.
