...
- **Built registry**: generated JSON files served to CLI consumers, usually
  from `public/r`. Use `npx shadcn build` to create this form.
...
npx shadcn search @acme -q "login"
npx shadcn view @acme/login-form
npx shadcn add @acme/login-form --dry-run
