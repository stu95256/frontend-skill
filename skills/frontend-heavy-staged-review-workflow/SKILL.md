...
5. Reviewer passes must come from actual VS Code Chat subagents invoked through `#tool:agent/runSubagent`.
...
13. Counted reviewers must either read `~/.copilot/skills/<skill-name>/SKILL.md` or receive coordinator-injected skill criteria.
