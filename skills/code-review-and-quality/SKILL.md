...
- For detailed security review guidance, see [security checklist](references/security-checklist.md).
- For performance review checks, see [performance checklist](references/performance-checklist.md).
